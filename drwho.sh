...
function f_linkDump {
    echo -e "      link dump"                 >> $permdir/$file.txt
    echo -e "   ----------------\n"             >> $permdir/$file.txt
...
echo -e "${B}  >>  Target: $target - $host_ip${D}\n"
    ...
    echo -e "  ${B}12)${D}   A,AAAA,MX,NS,PTR,SOA,SRV & TXT records"
...
function f_whoisOptions {
    ...
    echo -e "  43)  primary name server reverse whois summary"
    echo -e "  44)  custom whois request (domain)"
    echo -e "  45)  custom reverse whois request (IP)"
    f_solidShort
}

function f_geoOptions {
    echo -e "${B} IP geolocation options\n"
    echo -e "  51)  host geolocation"
    echo -e "  52)  'first' MX record geolocation"
    echo -e "  53)  primary name server geolocation"
    echo -e "  54)  custom IP geolocation"
    f_solidShort
}
...
function f_subEnumOptions {
    ...
    echo -e "  71)  search via hackertarget.com"
    echo -e "  72)  search via crt.sh"
    f_solidShort
}

function f_optionsHostSearch {
        echo -e "${B} address block reverse host search - options\n"
        echo "  81)  A record address block reverse host search            ($host_prefix.x)" 
        echo "  82)  MX record- address block reverse host search          ($mx_prefix.x)"
        echo "  83)  primary name server address block reverse host search ($soa_prefix.x)"
...
f_solidLong
f_textfileSeparator
echo -e "       A, AAAA, NS, MX, PTR & SOA records"          >> $permdir/$file.txt
echo -e "   ------------------------------------------\n\n"    >> $permdir/$file.txt
...
echo "$txt"  | fmt -w 80 -s  | tee -a $permdir/$file.txt
f_solidLong
;;
13)
#***********************  13) server certificates **************************
f_textfileSeparator
echo -e "       certificate information"      >> $permdir/$file.txt
echo -e "   --------------------------------\n\n" >> $permdir/$file.txt
f_solidLong
...
f_textfileSeparator
echo -e "       MX reverse whois summary"         >> $permdir/$file.txt
echo -e "   ---------------------------------\n"    >> $permdir/$file.txt
...
echo -e "${B}primary name server reverse whois summary\n"
echo -e " ${BDim}$soa_url - $soa_ip${D}\n"
echo -e "       primary name server reverse whois summary"         >> $permdir/$file.txt
echo -e "   -------------------------------------------------\n"    >> $permdir/$file.txt
...
read domainname
f_solidLong
echo -e "${B}$domainname whois Summary${D}\n"
echo -e "       whois Summary"        >> $permdir/$file.txt
echo -e "   ---------------------\n"   >> $permdir/$file.txt
echo -e "\nTARGET:  $domainname"        >> $permdir/$file.txt
...
;;
45)
#******************* 45) custom reverse whois lookup" **********************
f_solidLong
f_textfileSeparator
f_makeNewDir
echo -e "   Set target ${B}IP${D} - e.g. 45.33.32.156\n"
...
read address
f_solidLong
whois $address > $tempdir/rev-whois-lookup.txt
echo -e "${B}$address reverse whois summary${D}\n"
echo -e "       custom reverse whois summary"        >> $permdir/$file.txt
echo -e "   -------------------------------------\n"   >> $permdir/$file.txt
echo -e "TARGET: $address" >> $permdir/$file.txt
f_drwho | tee -a $permdir/$file.txt
f_removeDir
f_solidLong
f_whoisOptions
...
echo -e "       Host geolocation"        >> $permdir/$file.txt
echo -e "   ------------------------\n"  >> $permdir/$file.txt
echo -e "    $target - $host_ip \n\n" >> $permdir/$file.txt
...
echo -e " ${BDim}$mx_first_url - $mx_first_ip${D}\n"
echo -e "       MX Geolocation"         >> $permdir/$file.txt
echo -e "   ----------------------\n"    >> $permdir/$file.txt
echo -e "    $mx_first_url - $mx_first_ip\n\n" >> $permdir/$file.txt
...
f_solidLong
f_textfileSeparator
echo -e "${B}primary name server geolocation${D}\n"
soa_url=`dig soa +short $target | cut -d ' ' -f 1 | rev | cut -c 2- | rev`
soa_ip=`host -t A $soa_url | cut -d ' ' -f 4-`
echo -e " ${BDim}$soa_url - $soa_ip${D}\n"
echo -e "       primary name server geolocation"        >> $permdir/$file.txt
echo -e "   ---------------------------------------\n"    >> $permdir/$file.txt
echo -e "    $soa_url - $soa_ip\n\n" >> $permdir/$file.txt
address=`echo $soa_ip`
f_geoIP | tee -a $permdir/$file.txt
...
;;
54)
#*******************  54) custom IP geolocation via ip-api.co  **********************
f_makeNewDir
f_solidLong
f_textfileSeparator
echo -e "   Set Target ${B}IP${D} - e.g. 45.33.32.156\n"
...
read address
f_solidLong
echo -e "${B}$address geolocation${D}\n"
echo -e " ${BDim}target: $address ${D}\n"
echo -e "       custom IP geolocation"        >> $permdir/$file.txt
echo -e "   -----------------------------\n"  >> $permdir/$file.txt
...
echo -e "       HTTP headers"        >> $permdir/$file.txt
echo -e "   --------------------\n"     >> $permdir/$file.txt
...
echo -e "       subdomains (via hackertarget.com)"      >> $permdir/$file.txt
echo -e "   ------------------------------------------\n"  >> $permdir/$file.txt
echo -e "$target - $host_ip"                         >> $permdir/$file.txt
echo -e "$(date) \n"                               >> $permdir/$file.txt                                
curl -s https://api.hackertarget.com/hostsearch/?q=$target | sed 's/,/ -  /g' | tee -a $permdir/$file.txt
echo ''
f_solidLong
f_subEnumOptions
;;
...
echo -e "       subdomains (via crt.sh)"    >> $permdir/$file.txt
echo -e "   -------------------------------\n"  >> $permdir/$file.txt
echo -e "$target - $host_ip"                 >> $permdir/$file.txt
echo -e "$(date) \n"                         >> $permdir/$file.txt
curl -s https://crt.sh/?q=$target > $tempdir/crt.txt
cat $tempdir/crt.txt | grep $target | sed 's/<TD>//' | sed 's/<\/TD>//' | sed 's/<BR>/\n/g' | sed 's/^ *//' | 
sed '/<TD/d' | sed '/<\/A>/d' | sed '/<TITLE>/d' | sed '/<TH/d' | sort | uniq | tee -a $permdir/$file.txt
f_removeDir
f_solidLong
f_subEnumOptions
;;
...
echo -e "       A record reverse host Search"           >> $permdir/$file.txt
echo -e "   ------------------------------------\n"    >> $permdir/$file.txt
...
echo -e "       MX record - address block reverse host search"           >> $permdir/$file.txt
echo -e "   -----------------------------------------------------\n"       >> $permdir/$file.txt
...
echo -e "${B}primary name server address block reverse host search${D}\n\n"
echo -e "       primary name server - address block reverse host search"           >> $permdir/$file.txt
echo -e "   ----------------------------------------------------------------\n"      >> $permdir/$file.txt
f_hostSearch | tee -a  $permdir/$file.txt
echo '' | tee -a  $permdir/$file.txt
f_solidLong
...
echo -e "       reverse IP lookup"      >> $permdir/$file.txt
echo -e "   -------------------------\n" >> $permdir/$file.txt
...
echo -e "       zone transfer check"         >> $permdir/$file.txt
echo -e "   ---------------------------\n"  >> $permdir/$file.txt
...
echo -e "       whois & PTR"              >> $permdir/$file.txt
echo -e "   -------------------\n"         >> $permdir/$file.txt
...
echo -e "       IP geolocation"         >> $permdir/$file.txt
echo -e "   ----------------------\n"     >> $permdir/$file.txt
echo -e "    - $target - \n\n" >> $permdir/$file.txt
address=`echo $target`
f_geoIP | tee -a $permdir/$file.txt
...
echo -e "       reverse host search"       >> $permdir/$file.txt
echo -e "   ---------------------------\n\n" >> $permdir/$file.txt
