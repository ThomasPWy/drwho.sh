...
f_Short; grep -o -m 1 'HTML5'  $tempdir/ww.txt
...
echo -e "\n\n${B}Dependencies ${D}\n\n"
echo -e "cURL, dig, dublin traceroute, host, lynx, IPcalc, MTR, Nmap, openSSL, SIPcalc, TestSSL, THC IPv6 Attack Suite, tracepath\n"
;;
i)
...
f_Long | tee -a ${out} ; echo -e "[+] Subdomains (AAAA)\n\n" | tee -a ${out}
...
echo "[+] $x | BOGON: $is_bogon | $(jq -r '.countryCode' $tempdir/geo.json) | $(date)" | tee -a ${out} ; else
