...
echo -e "Please enter your API key into the designated field at the top of the script's source code" ; fi 
}
...
echo -e "bgpview.io, censys.io, certspotter.com, crt.sh, hackertarget.com, ripeSTAT Data API, SANS Internet Storm Center, \nsublister.com, whois.cymru.com, whois.pwhois.org, RIR whois Servers"
echo -e "\n\n${B}Dependencies ${D}\n"
echo -e "Essential: curl, dig, host, Ipcalc, MTR, Nmap, Openssl, Sipcalc, Testssl, THC IPv6 Attack Suite"
echo -e "Recommended: dublin-traceroute, tracepath\n"
echo -e "\nRecommended API Keys/Tokens: Project Honeypot\n"
;;
i)
